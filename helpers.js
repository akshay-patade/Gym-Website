...
const checkDob = (field) => {
    ...
    let result = moment(field, "MM/DD/YYYY").format("MM/DD/YYYY");
...
const checkUserGroupName = (field) => {
    ...
    if (!field)
        throw { code: 400, message: `Please pass UserCategoryName in the parameter` };
...
const checkUserGroupDescription = (field) => {
    ...
    if (!field)
        throw { code: 400, message: `Please pass UserCategoryDescription in the parameter` };
...
const checkProductDescription = (field) => {
    ...
    if (!field)
        throw { code: 400, message: `Please pass productDescription in the parameter` };
...
const checkBlogDescription = async (field) => {
    ...
    if (!field)
        throw { code: 400, message: `Please pass blog Description in the parameter` };
...
const checkSubscriptionName = async (field) => {
    ...
    if (!field)
        throw { code: 400, message: `Please pass Subscription Name in the parameter` };
...
const checkSubscriptionDescription = async (field) => {
    ...
    if (!field)
        throw { code: 400, message: `Please pass Subscription Description in the parameter` };
...
const checkSubscriptionAmount = async (field) => {
    ...
    if (!field)
        throw { code: 400, message: `Please pass Subscription Amount in the parameter` };
...
const checkSubscriptionDuration = async (field) => {
    ...
    if (!field)
        throw { code: 400, message: `Please pass Subscription Duration in the parameter` };
